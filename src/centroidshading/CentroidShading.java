...
/**
 * Added this to test the glsl centroid qualifier.
 * 
 * @author homac
 *
 */
public class CentroidShading extends Application {
	...
	private volatile boolean sample_shading = false;
	private volatile boolean msaa = true;

	public CentroidShading() {
